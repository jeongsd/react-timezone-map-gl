...
mapshaper temp/ne_10m_time_zones.shp -simplify dp keep-shapes 2.5% -o format=topojson temp/natural-earth-data.json
...
mapshaper temp/dist/combined_shapefile.shp -simplify dp keep-shapes 0.1% -o format=topojson temp/timezone-boundary-builder.json
